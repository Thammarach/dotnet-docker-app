...
pipeline {
    ...
    environment {
        ...
        DOCKER_REPO               = "thammarach/dotnet-docker-app"
    ...
    stages {
        ...
        // Stage 2: Restore dependencies และ Run test
        // ใช้ .NET SDK Docker image เพื่อความสม่ำเสมอ
        // dotnet restore: กู้คืน NuGet packages
